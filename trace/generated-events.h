...
typedef enum {
    ...
    TRACE_NET_RX_PKT_L4_CSUM_VALIDATE_PH_CSUM,
    TRACE_NET_RX_PKT_L4_CSUM_VALIDATE_CSUM,
    TRACE_NET_RX_PKT_L3_CSUM_VALIDATE_ENTRY,
    TRACE_NET_RX_PKT_L3_CSUM_VALIDATE_NOT_IP4,
    TRACE_NET_RX_PKT_L3_CSUM_VALIDATE_CSUM,
    ...
    TRACE_NET_RX_PKT_RSS_HASH,
    TRACE_NET_RX_PKT_RSS_ADD_CHUNK,
    TRACE_E1000E_CORE_WRITE,
    TRACE_E1000E_CORE_READ,
    TRACE_E1000E_CORE_MDIC_READ,
    TRACE_E1000E_CORE_MDIC_READ_UNHANDLED,
    TRACE_E1000E_CORE_MDIC_WRITE,
    TRACE_E1000E_CORE_MDIC_WRITE_UNHANDLED,
    TRACE_E1000E_CORE_EEEPROM_WRITE,
    TRACE_E1000E_CORE_CTRL_WRITE,
    ...
    TRACE_E1000E_LINK_AUTONEG_FLOWCTL,
    TRACE_E1000E_LINK_SET_PARAMS,
    TRACE_E1000E_LINK_READ_PARAMS,
    TRACE_E1000E_LINK_SET_EXT_PARAMS,
    TRACE_E1000E_LINK_STATUS,
    TRACE_E1000E_WRN_REGS_WRITE_RO,
    TRACE_E1000E_WRN_REGS_WRITE_UNKNOWN,
    TRACE_E1000E_WRN_REGS_READ_UNKNOWN,
    TRACE_E1000E_WRN_REGS_READ_TRIVIAL,
    ...
    TRACE_E1000E_TX_DESCR,
    TRACE_E1000E_TX_CSO_ZERO,
    TRACE_E1000E_RING_FREE_SPACE,
    TRACE_E1000E_RX_CAN_RECV_DISABLED,
    TRACE_E1000E_RX_CAN_RECV_RINGS_FULL,
    TRACE_E1000E_RX_CAN_RECV,
    TRACE_E1000E_RX_HAS_BUFFERS,
    TRACE_E1000E_RX_NULL_DESCRIPTOR,
    TRACE_E1000E_RX_FLT_UCAST_MATCH,
    TRACE_E1000E_RX_FLT_UCAST_MISMATCH,
    TRACE_E1000E_RX_FLT_INEXACT_MISMATCH,
    TRACE_E1000E_RX_FLT_VLAN_MISMATCH,
    TRACE_E1000E_RX_FLT_VLAN_MATCH,
    TRACE_E1000E_RX_DESC_PS_READ,
    TRACE_E1000E_RX_DESC_PS_WRITE,
    TRACE_E1000E_RX_DESC_BUFF_SIZES,
    TRACE_E1000E_RX_DESC_LEN,
    TRACE_E1000E_RX_DESC_BUFF_WRITE,
    TRACE_E1000E_RX_DESCR,
    TRACE_E1000E_RX_SET_RCTL,
    TRACE_E1000E_RX_RECEIVE_IOV,
    TRACE_E1000E_RX_PACKET_SIZE,
    TRACE_E1000E_RX_LINK_DOWN,
    TRACE_E1000E_RX_DISABLED,
    TRACE_E1000E_RX_OVERSIZED,
    TRACE_E1000E_RX_FLT_DROPPED,
    TRACE_E1000E_RX_WRITTEN_TO_GUEST,
    TRACE_E1000E_RX_NOT_WRITTEN_TO_GUEST,
    TRACE_E1000E_RX_INTERRUPT_SET,
    TRACE_E1000E_RX_INTERRUPT_DELAYED,
    TRACE_E1000E_RX_SET_CSO,
    TRACE_E1000E_RX_SET_RDT,
    TRACE_E1000E_RX_SET_RFCTL,
    TRACE_E1000E_RX_START_RECV,
    TRACE_E1000E_RX_RSS_STARTED,
    TRACE_E1000E_RX_RSS_DISABLED,
    TRACE_E1000E_RX_RSS_TYPE,
    TRACE_E1000E_RX_RSS_IP4,
    TRACE_E1000E_RX_RSS_IP6,
    TRACE_E1000E_RX_RSS_DISPATCHED_TO_QUEUE,
    TRACE_E1000E_RX_METADATA_PROTOCOLS,
    TRACE_E1000E_RX_METADATA_VLAN,
    TRACE_E1000E_RX_METADATA_RSS,
    TRACE_E1000E_RX_METADATA_IP_ID,
    TRACE_E1000E_RX_METADATA_ACK,
    TRACE_E1000E_RX_METADATA_PKT_TYPE,
    ...
    TRACE_E1000E_RX_METADATA_STATUS_FLAGS,
    TRACE_E1000E_RX_METADATA_IPV6_SUM_DISABLED,
    TRACE_E1000E_RX_METADATA_IPV6_FILTERING_DISABLED,
    TRACE_E1000E_VLAN_VET,
    TRACE_E1000E_VLAN_IS_VLAN_PKT,
    TRACE_E1000E_IRQ_SET_CAUSE,
    TRACE_E1000E_IRQ_MSI_NOTIFY,
    TRACE_E1000E_IRQ_THROTTLING_NO_PENDING_INTERRUPTS,
    TRACE_E1000E_IRQ_MSI_NOTIFY_POSTPONED,
    TRACE_E1000E_IRQ_LEGACY_NOTIFY_POSTPONED,
    TRACE_E1000E_IRQ_THROTTLING_NO_PENDING_VEC,
    TRACE_E1000E_IRQ_MSIX_NOTIFY_POSTPONED_VEC,
    TRACE_E1000E_IRQ_MSIX_NOTIFY,
    TRACE_E1000E_IRQ_LEGACY_NOTIFY,
    TRACE_E1000E_IRQ_MSIX_NOTIFY_VEC,
    TRACE_E1000E_IRQ_POSTPONED_BY_XITR,
    TRACE_E1000E_IRQ_CLEAR_IMS,
    TRACE_E1000E_IRQ_SET_IMS,
    TRACE_E1000E_IRQ_FIX_ICR_ASSERTED,
    TRACE_E1000E_IRQ_ADD_MSI_OTHER,
    TRACE_E1000E_IRQ_PENDING_INTERRUPTS,
    TRACE_E1000E_IRQ_SET_CAUSE_ENTRY,
    TRACE_E1000E_IRQ_SET_CAUSE_EXIT,
    TRACE_E1000E_IRQ_ICR_WRITE,
    TRACE_E1000E_IRQ_WRITE_ICS,
    TRACE_E1000E_IRQ_ICR_PROCESS_IAME,
    TRACE_E1000E_IRQ_READ_ICS,
    TRACE_E1000E_IRQ_READ_IMS,
    TRACE_E1000E_IRQ_ICR_READ_ENTRY,
    TRACE_E1000E_IRQ_ICR_READ_EXIT,
    TRACE_E1000E_IRQ_ICR_CLEAR_ZERO_IMS,
    TRACE_E1000E_IRQ_ICR_CLEAR_IAME,
    TRACE_E1000E_IRQ_IMS_CLEAR_EIAME,
    TRACE_E1000E_IRQ_IMS_CLEAR_SET_IMC,
    TRACE_E1000E_IRQ_FIRE_DELAYED_INTERRUPTS,
    TRACE_E1000E_IRQ_REARM_TIMER,
    TRACE_E1000E_IRQ_THROTTLING_TIMER,
    ...
    TRACE_E1000E_IRQ_EITR_SET,
    TRACE_E1000E_IRQ_ITR_SET,
    TRACE_E1000E_IRQ_FIRE_ALL_TIMERS,
    TRACE_E1000E_IRQ_ADDING_DELAYED_CAUSES,
    TRACE_E1000E_IRQ_MSIX_PENDING_CLEARING,
    TRACE_E1000E_WRN_MSIX_VEC_WRONG,
    TRACE_E1000E_WRN_MSIX_INVALID,
    TRACE_E1000E_MAC_SET_PERMANENT,
    TRACE_E1000E_MAC_SET_SW,
    TRACE_E1000E_MAC_INDICATE,
    TRACE_E1000E_CB_PCI_REALIZE,
    TRACE_E1000E_CB_PCI_UNINIT,
    TRACE_E1000E_CB_QDEV_RESET,
    TRACE_E1000E_CB_PRE_SAVE,
    TRACE_E1000E_CB_POST_LOAD,
    TRACE_E1000E_IO_WRITE_ADDR,
    TRACE_E1000E_IO_WRITE_DATA,
    TRACE_E1000E_IO_READ_ADDR,
    TRACE_E1000E_IO_READ_DATA,
    TRACE_E1000E_WRN_IO_WRITE_UNKNOWN,
    TRACE_E1000E_WRN_IO_READ_UNKNOWN,
    TRACE_E1000E_WRN_IO_ADDR_UNDEFINED,
    TRACE_E1000E_WRN_IO_ADDR_FLASH,
    TRACE_E1000E_WRN_IO_ADDR_UNKNOWN,
    TRACE_E1000E_WRN_FLASH_READ,
    TRACE_E1000E_WRN_FLASH_WRITE,
    TRACE_E1000E_MSI_INIT_FAIL,
    TRACE_E1000E_MSIX_INIT_FAIL,
    TRACE_E1000E_MSIX_USE_VECTOR_FAIL,
    TRACE_E1000E_CFG_SUPPORT_VIRTIO,
    TRACE_EVENT_COUNT
} TraceEventID;
...
#define TRACE_NET_RX_PKT_L4_CSUM_VALIDATE_PH_CSUM_ENABLED 1
...
#define TRACE_E1000E_LINK_NEGOTIATION_START_ENABLED 1
#define TRACE_E1000E_LINK_NEGOTIATION_DONE_ENABLED 1
...
#define TRACE_E1000E_TX_CSO_ZERO_ENABLED 1
#define TRACE_E1000E_RING_FREE_SPACE_ENABLED 1
#define TRACE_E1000E_RX_CAN_RECV_DISABLED_ENABLED 1
...
#define TRACE_E1000E_RX_FLT_UCAST_MATCH_ENABLED 1
#define TRACE_E1000E_RX_FLT_UCAST_MISMATCH_ENABLED 1
#define TRACE_E1000E_RX_FLT_INEXACT_MISMATCH_ENABLED 1
...
#define TRACE_E1000E_RX_LINK_DOWN_ENABLED 1
#define TRACE_E1000E_RX_DISABLED_ENABLED 1
#define TRACE_E1000E_RX_OVERSIZED_ENABLED 1
...
#define TRACE_E1000E_VLAN_IS_VLAN_PKT_ENABLED 1
...
#define TRACE_E1000E_IRQ_IMS_CLEAR_EIAME_ENABLED 1
...
#define TRACE_E1000E_MAC_INDICATE_ENABLED 1
...
#define TRACE_E1000E_WRN_FLASH_READ_ENABLED 1
#define TRACE_E1000E_WRN_FLASH_WRITE_ENABLED 1
